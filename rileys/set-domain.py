...
Usage:
    python3 set-domain.py rileysbarbers.co.uk

Then check nothing was missed:
    grep -r "ejpc.github.io/manningtree/rileys" .
"""
import pathlib
import re
import sys

CURRENT = "ejpc.github.io/manningtree/rileys"
FILES = ["index.html", "services.html", "sitemap.xml", "robots.txt"]
